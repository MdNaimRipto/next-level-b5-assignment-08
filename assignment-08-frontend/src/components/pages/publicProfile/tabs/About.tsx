    ...
    <div className="w-full bg-white shadow-md p-6 md:p-8">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center">
        <div>
          ...
          <p className="text-sm text-secondary1/70 mt-1">{host?.role}</p>
        </div>
      </div>
      ...
      {host?.bio && (
        <div className="mt-6">
          ...
          <p className="text-secondary1/80">{host?.bio}</p>
        </div>
      )}
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 text-secondary1 2xl:max-w-[1000px] mb-6">
        <div>
          ...
          <p className="text-secondary1">{host?.email}</p>
        </div>
        <div>
          <h3 className="text-sm font-medium text-secondary1/70">Phone</h3>
          <p className="text-secondary1">{host?.contactNumber}</p>
        </div>
        <div className="mt-3">
          ...
          >
            {host?.activeStatus ? "Active" : "Inactive"}
          </p>
        </div>
        <div className="mt-3">
          <h3 className="text-sm font-medium text-secondary1/70">Interests</h3>
          {host?.interests && host?.interests.length ? (
